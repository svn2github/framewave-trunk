...
SSP_FORCEINLINE __m128i ssp_comeq_epi64_REF(__m128i a, __m128i b)
{
    ...
    A.i = a;
    B.i = b;
    A.u64[0] = (A.s64[0]==B.s64[0]) ? 0xFFFFFFFFFFFFFFFFULL : 0;
    A.u64[1] = (A.s64[1]==B.s64[1]) ? 0xFFFFFFFFFFFFFFFFULL : 0;
    return A.i;
}
...
SSP_FORCEINLINE __m128i ssp_comeq_epu64_REF(__m128i a, __m128i b)
{
    ...
    A.i = a;
    B.i = b;
    A.u64[0] = (A.u64[0]==B.u64[0]) ? 0xFFFFFFFFFFFFFFFFULL : 0;
    A.u64[1] = (A.u64[1]==B.u64[1]) ? 0xFFFFFFFFFFFFFFFFULL : 0;
    return A.i;
}
...
SSP_FORCEINLINE __m128d ssp_comeq_pd_REF(__m128d a, __m128d b)
{
    ...
    A.d = a;
    B.d = b;
    A.u64[0] = (A.f64[0]==B.f64[0]) ? 0xFFFFFFFFFFFFFFFFULL : 0;
    A.u64[1] = (A.f64[1]==B.f64[1]) ? 0xFFFFFFFFFFFFFFFFULL : 0;
    return A.d;
}
...
SSP_FORCEINLINE __m128d ssp_comunord_pd_REF(__m128d a, __m128d b)
{
    ...
    A.d = a;
    B.d = b; // NAN(A)              || NAN(B)         
    A.u64[0] = ((A.f64[0]!=A.f64[0]) || (B.f64[0]!=B.f64[0])) ? 0xFFFFFFFFFFFFFFFFULL : 0;
    A.u64[1] = ((A.f64[1]!=A.f64[1]) || (B.f64[1]!=B.f64[1])) ? 0xFFFFFFFFFFFFFFFFULL : 0;
    return A.d;
}
...
SSP_FORCEINLINE __m128d ssp_comnlt_pd_REF(__m128d a, __m128d b)
{
    ...
    A.u64[0] = (A.f64[0]<B.f64[0]) ? 0 : 0xFFFFFFFFFFFFFFFFULL;
    A.u64[1] = (A.f64[1]<B.f64[1]) ? 0 : 0xFFFFFFFFFFFFFFFFULL;
...
SSP_FORCEINLINE __m128d ssp_comord_pd_REF(__m128d a, __m128d b)
{
    ...
    A.d = a;
    B.d = b; // NAN(A)              || NAN(B)         
    A.u64[0] = (A.f64[0]!=A.f64[0]) || (B.f64[0]!=B.f64[0]) ? 0 : 0xFFFFFFFFFFFFFFFFULL;
    A.u64[1] = (A.f64[1]!=A.f64[1]) || (B.f64[1]!=B.f64[1]) ? 0 : 0xFFFFFFFFFFFFFFFFULL;
    return A.d;
}
...
SSP_FORCEINLINE __m128d ssp_comueq_pd_REF(__m128d a, __m128d b)
{
    ...
    A.d = a;
    B.d = b;
    A.u64[0] = ((A.f64[0]<B.f64[0]) || (A.f64[0]>B.f64[0])) ? 0 : 0xFFFFFFFFFFFFFFFFULL;
    A.u64[1] = ((A.f64[1]<B.f64[1]) || (A.f64[1]>B.f64[1])) ? 0 : 0xFFFFFFFFFFFFFFFFULL;
    return A.d;
}
...
SSP_FORCEINLINE __m128d ssp_comoneq_pd_REF(__m128d a, __m128d b)
{
    ...
    A.d = a;
    B.d = b; 
    A.u64[0] = ((A.f64[0]<B.f64[0]) || (A.f64[0]>B.f64[0]))  ? 0xFFFFFFFFFFFFFFFFULL : 0;
    A.u64[1] = ((A.f64[1]<B.f64[1]) || (A.f64[1]>B.f64[1]))  ? 0xFFFFFFFFFFFFFFFFULL : 0;
    return A.d;   
}
