...
static SYS_FORCEALIGN_16 short img_idct_weighting[] = {
...
static int Idct_SSE2(const Fw16s* pSrc, Fw16s* pDst)
{
	...
	pesi = img_idct_weighting;
	pecx = img_idct_weighting+64;
	...
	pesi = img_idct_weighting + 96;
	rxmm12 = _mm_loadu_si128((__m128i *)(peax+8)); 

	pecx = img_idct_weighting + 32;
	...
	rxmm1 = _mm_load_si128((__m128i *)(img_idct_weighting+144));
	rxmm0 = _mm_mulhi_epi16(rxmm0, rxmm1);
	rxmm5 = _mm_load_si128((__m128i *)(img_idct_weighting+128));
	...
	rxmm1 = rxmm0;
	rxmm3 = _mm_load_si128((__m128i *)(img_idct_weighting+136));
	...
	rxmm1 = rxmm4;
	rxmm0 = _mm_load_si128((__m128i *)(img_idct_weighting+152));
	rxmm2 = rxmm0;
