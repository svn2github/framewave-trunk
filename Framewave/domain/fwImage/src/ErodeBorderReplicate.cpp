...
typedef struct 
{
	...
	FwiPoint anchor;
	Fw8u* pMask_pad;
}	fwiErodeBorderReplicate_8u_Not_In_Place;

#ifdef Hai_DEBUG
void printout_erodeBorder(Fw8u* pSrc, int width, int height, int channel)
{
...
//void setBufferLineZero_ErodeBorderReplicate(Fw8u* pDst, int dstStep, int channel)
//{
//	Fw8u* pd = pDst;
...
FwStatus MyFW_ErodeBorderReplicate(const TS* pSrc, int srcStep, TS* pDst,
									  int dstStep, FwiSize roiSize, FwiBorderType border, FwiMorphState* pState)
{
	...
	//Here, other vendors might not check if all pMask elements are zero or not. But in the Erode, they did.
...
void padMask_16_C1R_erodeBorderReplicate(Fw8u* pMask, Fw8u* pMask_pad, int pMask_padWidth, FwiSize maskSize)
{
	int counter = 0;
	int x = 0, y = 0;
...
void padMask_32_C1R_erodeBorderReplicate(Fw8u* pMask, Fw8u* pMask_pad, int pMask_padWidth, FwiSize maskSize)
{
...
void padMask_32_C3R_ErodeBorderReplicate(Fw8u* pMask, Fw8u* pMask_pad, int pMask_padWidth, FwiSize maskSize)
{
	for(int y = 0; y < maskSize.height; y++)
	{
		for(int x = 0; x < pMask_padWidth; x++)
...
void padMask_16_C3R_erodeBorderReplicate(Fw8u* pMask, Fw8u* pMask_pad, int pMask_padWidth, FwiSize maskSize)
{
	for(int y = 0; y < maskSize.height; y++)
	{
		for(int x = 0; x < pMask_padWidth; x++)
...
void padMask_16_C4R_erodeBorderReplicate(Fw8u* pMask, Fw8u* pMask_pad, int pMask_padWidth, FwiSize maskSize)
{
	for(int y = 0; y < maskSize.height; y++)
	{
		for(int x = 0; x < pMask_padWidth; x++)
...
void initResultMask_C1R_ErodeBorderReplicate(Fw8u* resultMask, int padMaskWidth, FwiSize maskSize)
{
...
void initResultMask_C3R_ErodeBorderReplicate(Fw8u* resultMask, int padMaskWidth, FwiSize maskSize, int channel)
{
...
void initResultMask_C4R_ErodeBorderReplicate(Fw8u* resultMask, int padMaskWidth, FwiSize maskSize, int channel)
{
	for(int i = 0; i < padMaskWidth; i+=channel)
	{
		if((i % (maskSize.width*channel) == 0) && (i < (padMaskWidth - maskSize.width*channel)))
...
void erodeBorderReplicate_8u_ref(const Fw8u* pSrc, int srcStep, Fw8u* pDst, int dstStep, FwiSize roiSize,
...
*/
void erodeBorderReplicate_C1R_SSE2_16(const Fw8u* pSrc, int srcStep, Fw8u* pDst, int dstStep, FwiSize roiSize,
					 ...
					 FwiPoint anchor, int channel, int yBegin, int yEnd)
{
	...
	{
		setBufferLineZero_ErodeBorderReplicate(pd, dstStep, 1);
	}
	...
	*/
	...
	initResultMask_C1R_ErodeBorderReplicate(resultMask, pMask_pad_width, maskSize);
	...
	for(y = yBegin; y < yEnd; y++, pSrc += srcStep, pDst += dstStep)
	{
		...
		//initialize the pDst
		setBufferLineZero_ErodeBorderReplicate(pDst, (mEnd-anchor.x), 1);
...
void erodeBorderReplicate_C1R_SSE2_32(const Fw8u* pSrc, int srcStep, Fw8u* pDst, int dstStep, FwiSize roiSize,
					 Fw8u* pMask_reflect, Fw8u* pMask_pad, FwiSize maskSize, int pMask_pad_width,
					 FwiPoint anchor, int channel, int yBegin, int yEnd)
{
	channel = 1;
...
void erodeBorderReplicate_C3R_SSE2_16(const Fw8u* pSrc, int srcStep, Fw8u* pDst, int dstStep, FwiSize roiSize,
					 Fw8u* pMask_reflect, Fw8u* pMask_pad, FwiSize maskSize, int pMask_pad_width,
					 FwiPoint anchor, int channel, int yBegin, int yEnd)
{
	channel = 3;
	...
	//Create a mask just for save the dilation result to the pDst
	Fw8u* resultMask = (Fw8u*) fwMalloc(sizeof(Fw8u) * (pMask_pad_width * 1));
	initResultMask_C3R_ErodeBorderReplicate(resultMask, pMask_pad_width, maskSize, channel);
	__m128i rmask = *(__m128i*)(resultMask);
	...
	for(y = yBegin; y < yEnd; y++, pSrc += srcStep, pDst += dstStep)
	{
		...
		//initialize the pDst
		setBufferLineZero_ErodeBorderReplicate(pDst, (mEnd-anchor.x*channel), 1);
...
void erodeBorderReplicate_C3R_SSE2_32(const Fw8u* pSrc, int srcStep, Fw8u* pDst, int dstStep, FwiSize roiSize,
					 Fw8u* pMask_reflect, Fw8u* pMask_pad, FwiSize maskSize, int pMask_pad_width,
					 FwiPoint anchor, int channel, int yBegin, int yEnd)
{
	channel = 3;
...
void erodeBorderReplicate_C4R_SSE2_16(const Fw8u* pSrc, int srcStep, Fw8u* pDst, int dstStep, FwiSize roiSize,
					 Fw8u* pMask_reflect, Fw8u* pMask_pad, FwiSize maskSize, int pMask_pad_width,
					 FwiPoint anchor, int channel, int yBegin, int yEnd)
{
	channel = 4;
	...
	//Create a mask just for save the dilation result to the pDst
	Fw8u* resultMask = (Fw8u*) fwMalloc(sizeof(Fw8u) * (pMask_pad_width * 1));
	initResultMask_C4R_ErodeBorderReplicate(resultMask, pMask_pad_width, maskSize, channel);
	__m128i rmask = *(__m128i*)(resultMask);
...
void erodeBorderReplicate_C4R_SSE2_32(const Fw8u* pSrc, int srcStep, Fw8u* pDst, int dstStep, FwiSize roiSize,
					 Fw8u* pMask_reflect, Fw8u* pMask_pad, FwiSize maskSize, int pMask_pad_width,
					 FwiPoint anchor, int channel, int yBegin, int yEnd)
{
	channel = 4;
...
void My_fwiErodeBorderReplicate_8u_C1R(void* param)
{
	fwiErodeBorderReplicate_8u_Not_In_Place *erode_par = (fwiErodeBorderReplicate_8u_Not_In_Place *) param;
	...
	if(maskSize.width <= 16)
	{
		padMask_16_C1R_erodeBorderReplicate(pMask, pMask_pad, pMask_pad_width, maskSize);
		erodeBorderReplicate_C1R_SSE2_16(pSrc, srcStep, pDst, dstStep, roiSize, pMask, pMask_pad, maskSize, pMask_pad_width, anchor, channel, yBegin, yEnd);
	}
	else if (maskSize.width > 16 && maskSize.width <= 32)
	{
		padMask_32_C1R_erodeBorderReplicate(pMask, pMask_pad, pMask_pad_width, maskSize);
		erodeBorderReplicate_C1R_SSE2_32(pSrc, srcStep, pDst, dstStep, roiSize, pMask, pMask_pad, maskSize, pMask_pad_width, anchor, channel, yBegin, yEnd);
	}
	else if (maskSize.width > 32 && maskSize.width <= 64)
		pMask_pad_width = 64;
	else if (maskSize.width > 64 && maskSize.width <= 128)
...
void My_fwiErodeBorderReplicate_8u_C3R(void* param)
{
	fwiErodeBorderReplicate_8u_Not_In_Place *erode_par = (fwiErodeBorderReplicate_8u_Not_In_Place *) param;
	...
	if(maskSize.width <= 5)
	{
		...
		padMask_16_C3R_erodeBorderReplicate(pMask, pMask_pad, pMask_pad_width, maskSize);
		//printout_erodeBorder(pMask_pad, pMask_pad_width, maskSize.height, 1);
		erodeBorderReplicate_C3R_SSE2_16(pSrc, srcStep, pDst, dstStep, roiSize, pMask, pMask_pad, maskSize, pMask_pad_width, anchor, channel, yBegin, yEnd);
	}
	else if (maskSize.width > 5 && maskSize.width <= 10)
	{
		padMask_16_C3R_erodeBorderReplicate(pMask, pMask_pad, pMask_pad_width, maskSize);
		//printout(pMask_pad, pMask_pad_width, maskSize.height, 1);
		erodeBorderReplicate_C3R_SSE2_32(pSrc, srcStep, pDst, dstStep, roiSize, pMask, pMask_pad, maskSize, pMask_pad_width, anchor, channel, yBegin, yEnd);
	}
	else if (maskSize.width > 10 && maskSize.width <= 16)
	{
		pMask_pad_width = 48;
...
void My_fwiErodeBorderReplicate_8u_C4R(void* param)
{
	fwiErodeBorderReplicate_8u_Not_In_Place *erode_par = (fwiErodeBorderReplicate_8u_Not_In_Place *) param;
	...
	{
		//Circulate padding the mask to fit into 16 bytes SSE2 register
		padMask_16_C4R_erodeBorderReplicate(pMask, pMask_pad, pMask_pad_width, maskSize);
		//printout(pMask_pad, pMask_pad_width, maskSize.height, 1);
		erodeBorderReplicate_C4R_SSE2_16(pSrc, srcStep, pDst, dstStep, roiSize, pMask, pMask_pad, maskSize, pMask_pad_width, anchor, channel, yBegin, yEnd);
	}
	else if (maskSize.width > 4 && maskSize.width <= 8)
	{
		padMask_16_C4R_erodeBorderReplicate(pMask, pMask_pad, pMask_pad_width, maskSize);
		//printout(pMask_pad, pMask_pad_width, maskSize.height, 1);
		erodeBorderReplicate_C4R_SSE2_32(pSrc, srcStep, pDst, dstStep, roiSize, pMask, pMask_pad, maskSize, pMask_pad_width, anchor, channel, yBegin, yEnd);
	}
	else if (maskSize.width > 8 && maskSize.width <= 12)
	{
		pMask_pad_width = 48;
...
FwStatus PREFIX_OPT(OPT_PREFIX, fwiErodeBorderReplicate_8u_C1R)(const Fw8u* pSrc, int srcStep, Fw8u* pDst, 
									  int dstStep, FwiSize roiSize, FwiBorderType border, FwiMorphState* pState) 
{
	switch( Dispatch::Type<DT_SSE2>())
	{
		...
		case DT_SSE2:
		{
			...
			*/
			...
			fwiErodeBorderReplicate_8u_Not_In_Place erodeBorderReplicate_par[MAXTHREADNUM];
...
//#endif
			...
			if(total_thread_num >= 1)
			{
				...
				for(thread_num=0; thread_num<total_thread_num; thread_num++)
				{
					...
					{
						y_end = roiSize.height-pState->maskSize.height;
					}
					...
					erodeBorderReplicate_par[thread_num].pSrc = pSrc;
					erodeBorderReplicate_par[thread_num].srcStep = srcStep;
					erodeBorderReplicate_par[thread_num].pDst = pDst;
					erodeBorderReplicate_par[thread_num].dstStep = dstStep;
					erodeBorderReplicate_par[thread_num].roiSize = roiSize;
					erodeBorderReplicate_par[thread_num].yBegin = y_bgn;
					erodeBorderReplicate_par[thread_num].yEnd = y_end;
					erodeBorderReplicate_par[thread_num].channel = channel;
					erodeBorderReplicate_par[thread_num].pMask = pState->pMask;
					erodeBorderReplicate_par[thread_num].maskSize = pState->maskSize;
					erodeBorderReplicate_par[thread_num].anchor = pState->anchor;

					ThreadPool::Run(My_fwiErodeBorderReplicate_8u_C1R, (void *) &erodeBorderReplicate_par[thread_num]);
				}
			...
			erodeBorderReplicate_8u_ref(pSrc, srcStep, pDst, dstStep, roiSize, 
			...
			erodeBorderReplicate_8u_ref(pSrc, srcStep, pDst, dstStep, roiSize, 
				pState->pMask, pState->maskSize, pState->anchor, channel, 
				0, roiSize.width, roiSize.height-pState->maskSize.height, roiSize.height);

			return fwStsNoErr;
		}
		default:
			return MyFW_ErodeBorderReplicate<Fw8u, C1, DT_REFR> (pSrc, srcStep, pDst, dstStep, roiSize, border, pState);
	}
}

FwStatus PREFIX_OPT(OPT_PREFIX, fwiErodeBorderReplicate_8u_C3R)(const Fw8u* pSrc, int srcStep, Fw8u* pDst, 
									  int dstStep, FwiSize roiSize, FwiBorderType border, FwiMorphState* pState) 
{
	switch( Dispatch::Type<DT_SSE2>())
	{
...
//#endif
				...
				for(thread_num=0; thread_num<total_thread_num; thread_num++)
				{
					...
					ThreadPool::Run(My_fwiErodeBorderReplicate_8u_C3R, (void *) &erodeBorderReplicate_par[thread_num]);
				}
		...
		default:
			return MyFW_ErodeBorderReplicate<Fw8u, C3, DT_REFR> (pSrc, srcStep, pDst, dstStep, roiSize, border, pState);
	}
}

FwStatus PREFIX_OPT(OPT_PREFIX, fwiErodeBorderReplicate_8u_C4R)(const Fw8u* pSrc, int srcStep, Fw8u* pDst, 
									  int dstStep, FwiSize roiSize, FwiBorderType border, FwiMorphState* pState) 
{
switch( Dispatch::Type<DT_SSE2>())
	{
...
//#endif
			...
			if(total_thread_num >= 1)
			{
				...
				for(thread_num=0; thread_num<total_thread_num; thread_num++)
				{
					...
					ThreadPool::Run(My_fwiErodeBorderReplicate_8u_C4R, (void *) &erodeBorderReplicate_par[thread_num]);
				}
		...
		default:
			return MyFW_ErodeBorderReplicate<Fw8u, C4, DT_REFR> (pSrc, srcStep, pDst, dstStep, roiSize, border, pState);
	}
}

FwStatus PREFIX_OPT(OPT_PREFIX, fwiErodeBorderReplicate_32f_C1R)(const Fw32f* pSrc, int srcStep, Fw32f* pDst, 
									  int dstStep, FwiSize roiSize, FwiBorderType border, FwiMorphState* pState) 
{
	return MyFW_ErodeBorderReplicate<Fw32f, C1, DT_REFR> (pSrc, srcStep, pDst, dstStep, roiSize, border, pState);
}

FwStatus PREFIX_OPT(OPT_PREFIX, fwiErodeBorderReplicate_32f_C3R)(const Fw32f* pSrc, int srcStep, Fw32f* pDst, 
									  int dstStep, FwiSize roiSize, FwiBorderType border, FwiMorphState* pState) 
{
	return MyFW_ErodeBorderReplicate<Fw32f, C3, DT_REFR> (pSrc, srcStep, pDst, dstStep, roiSize, border, pState);
}

FwStatus PREFIX_OPT(OPT_PREFIX, fwiErodeBorderReplicate_32f_C4R)(const Fw32f* pSrc, int srcStep, Fw32f* pDst, 
									  int dstStep, FwiSize roiSize, FwiBorderType border, FwiMorphState* pState) 
{
	return MyFW_ErodeBorderReplicate<Fw32f, C4, DT_REFR> (pSrc, srcStep, pDst, dstStep, roiSize, border, pState);
}
