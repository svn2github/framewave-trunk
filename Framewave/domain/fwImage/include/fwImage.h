...
todo:publish
#Technologies - REF, SSE2
#Short - Max of image data
#Long - <Text>These functions step through an ROI in a source buffer and finds the maximum value in the buffer</Text>
*/
...
/*#FunctionBlock - Min Max
todo:publish
#Technologies - REF, SSE2
#Short - Min Max of image data
#Long - <Text>These functions step through an ROI in a source buffer and finds the maximum  and minumum value in the buffer</Text>
*/
...
todo:publish
#Technologies - REF, SSE2
#Short - Find Mean of image data
#Long - <Text>These functions step through an ROI in a source buffer and finds the mean of the buffer</Text>
*/
...
/*#FunctionBlock - Count in Range
todo:publish
#Technologies - REF
#Short -Counts the number of pixels in given range
#Long - <Text>These functions step through an ROI in a source buffer and counts the number of pixels in given lover and upper range (inclusive) </Text>
*/
