...
/*#FunctionBlock - Autocorrelation Functions
TODO:edit
#Technologies - REF, SSE2
#Short - Estimates normal, biased, and unbiased auto-correlation of a vector and stores the result in a second vector.
#Long -  Estimates normal, biased, and unbiased auto-correlation of a vector and stores the result in a second vector.
#ReturnValues - fwStsNoErr, fwStsNullPtrErr, fwStsLengthErr
*/
